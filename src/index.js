...
createNewFlashCardLocally('What is module and why to use it? Pros and cons.', 'Pros: \"Modules\" refers to small units of independent, reusable code. Cons: Used mostly in big projects.');
...
createNewFlashCardLocally('How many ways of using modules you are aware of?', 'Node.js modules use \"require\". ES6 modules use \"import/export\". Asynchronous Module use \"define\".');
...
createNewFlashCardLocally('What is the value of \'this\' in event handlers?', 'Every browser sets \'this\' to the element which fired the event.');
...
createNewFlashCardLocally('Provide a practical example of AJAX call.', 'xmlhttp.open(\"GET\", \"mypage.php?q=\", true);');
...
createNewFlashCardLocally('What are async/await keywords?', '\'Async\' before a function means a function always returns a promise. \'Await\' makes JavaScript wait until that promise settles and returns its result.');
